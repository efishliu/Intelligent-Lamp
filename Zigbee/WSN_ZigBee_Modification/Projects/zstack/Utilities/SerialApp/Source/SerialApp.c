...
static uint16 EndDeviceID = 0x0314; //终端ID，重要
//---------------------------------------------------------------------
...
uint8 NodeData[MAX_NODE][7];         //终端数据缓冲区 0=温度 1=湿度 2=气体 3=灯
